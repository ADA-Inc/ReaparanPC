...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  lista = (ListView) findViewById(R.id.listViewHome);
        ArrayAdapter adaptador = new ArrayAdapter(this, android.R.layout.simple_list_item_1, mImageIds);
...
//VIEWPAGERa linux
        ...
        mViewPager = (ViewPager) findViewById(R.id.pagera);
        ...
        mViewPager = (ViewPager) findViewById(R.id.pagerb);
